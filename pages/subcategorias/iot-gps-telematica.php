...
<head>
    ...
    <title>IoT / GPS / Telemática y Señalización Audiovisual </title>
    <!-- icons -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-12 text-center mb-4">
                    <h2>IoT / GPS / Telemática y Señalización Audiovisual - Productos</h2>
                </div>

                <div id="infoProductos" class="row">
...
<script src="./asset/js/custom.js"></script> -->
    ...
    <script type="text/javascript" src="../../asset/js/productos/app-iot.js"></script>
</body>
