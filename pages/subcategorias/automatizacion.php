...
<head>
    ...
    <title>Automatización e Intrusión</title>
    <!-- icons -->
...
<body id="section_1">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-12 text-center mb-4">
                    <h2>Automatización e Intrusión - Productos</h2>
                </div>
    ...
    <script type="text/javascript" src="../../asset/js/productos/app-automatizacion.js"></script>
</body>
